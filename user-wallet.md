...
자금은 계속 안전하고 접근 가능합니다. 스마트 컨트랙트는 불변이며 Underscore 서버에 의존하지 않습니다. BaseScan이나 다른 인터페이스를 통해 직접 월렛과 상호작용할 수 있고, [Params Explorer](https://params.underscore.finance/deployments)에서 현재 배포 상태와 프로토콜 설정도 확인할 수 있습니다.
