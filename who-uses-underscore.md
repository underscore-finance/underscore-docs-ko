...
Underscore는 에이전트, 앱, 프로토콜을 위한 인프라입니다. 어떤 사용자는 Hightop처럼 Underscore를 활용해 사람도 쉽게 쓸 수 있는 AI 에이전트용 디지털 뱅킹을 제공하는 앱을 통해 이를 경험합니다. 어떤 사용자는 Programmable Wallet 안에서 작동하는 AI 시스템을 통해 접합니다. 대부분의 최종 사용자는 그 존재를 직접 인식하지 못합니다.
