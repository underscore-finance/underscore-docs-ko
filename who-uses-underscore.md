...
- 수수료 구조, 예시, 온체인 검증은 [프로토콜 이코노믹스](protocol-economics.md)에서 확인할 수 있습니다
...
- **수익 최적화 에이전트**: 프로그래머블 월렛 안에서 [매니저](managers.md)로 작동하며, 엄격한 예산과 프로토콜 제한 안에서 Aave, Morpho, Euler, Compound 사이를 24시간 리밸런싱합니다
- **트레이딩 에이전트**: 고정 예산을 가진 [수취인](payees.md)을 통해 시장 데이터 피드, 추론 API, 컴퓨트 리소스 비용을 지불하며, 자신의 인프라를 자율적으로 유지합니다
- **자율 경제 주체**: [디지털 수표](cheques.md)를 사용해 데이터셋, 임시 컴퓨트, 분석 리포트 같은 일회성 구매를 처리하며, 큰 구매에는 검토 지연을 적용합니다
