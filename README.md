...
1. **[Earn Vaults](vaults.md)** — 같은 지분 아키텍처 위에서 두 가지 수익 프로필을 제공합니다. 핵심 Vaults는 패시브 AI 관리형 수익을, Amplified Vaults는 USD 기준 부채 안전성을 유지하면서 Ripe 기반 두 번째 수익 레이어를 제공합니다.
...
- **Amplified Vaults** — 핵심 Vault 지분 토큰 위에 구축되며, USD 기준 부채 안전성을 유지하면서 Ripe를 사용해 두 번째 수익 레이어를 더하는 구조
...
**이런 분께 적합합니다:** 패시브 수익을 원하는 사용자, 수익 창출형 담보가 필요한 프로토콜, 직접 수익 또는 증폭 수익 기능을 추가하려는 핀테크 앱
