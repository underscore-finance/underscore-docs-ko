...
1. **수익 보너스** — 수익 이익에 대해 1:1로 RIPE를 추가 지급
2. **예치 보상** — 얼마나 많이, 얼마나 오래 보유했는지에 따라 RIPE 지급

친구를 초대하면, 그 친구가 만든 수익 이익에 대해서도 RIPE를 받을 수 있습니다.

---

## 수익 보너스 (1:1 RIPE 매칭)

수익 이익이 실현되면 추가 RIPE 토큰을 받습니다.
...
- **[Vault에 예치하기](vaults.md)**: AI 최적화 수익 + RIPE 보너스 획득
